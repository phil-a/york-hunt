...
activated: true,
activated_at: Time.zone.now)
User.create!(name:  "House Creative",
email: "lassondecreative@gmail.com",
password: "create1234",
password_confirmation: "create1234",
admin: false,
activated: true,
activated_at: Time.zone.now)
User.create!(name:  "House Rational",
email: "lassonderational@gmail.com",
password: "ration1234",
password_confirmation: "ration1234",
admin: false,
activated: true,
activated_at: Time.zone.now)
User.create!(name:  "House Passionate",
email: "lassondepassionate@gmail.com",
password: "passion1234",
password_confirmation: "passion1234",
admin: false,
activated: true,
activated_at: Time.zone.now)
User.create!(name:  "House Ingenious",
email: "lassondeingenious@gmail.com",
password: "1234ingenious",
password_confirmation: "1234ingenious",
admin: false,
activated: true,
activated_at: Time.zone.now)
User.create!(name:  "House Confident",
email: "lassondeconfident@gmail.com",
password: "confident4321",
password_confirmation: "confident4321",
admin: false,
activated: true,
activated_at: Time.zone.now)
# 99.times do |n|
